...
class _LoginPageState extends State<LoginPage> {
        ...
        body: FormBuilder(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Expanded(flex: 2, child: _buildFormSignIn(context)),
              ],
            ),
          ),
        ));
  ...
  Widget _buildFormSignIn(BuildContext context) {
    return Material(
      child: Stack(
        children: <Widget>[
          Padding(
  ...
  Widget _buildBranchTravel() {
    return FormBuilderDropdown(
      ...
      onChanged: (val) {
        ...
        _loginStore.setBranch(endpointsAPI);
      },
  ...
  Widget _buildEmailField() {
    return FormBuilderTextField(
      ...
      onChanged: (val) {
        _loginStore.setEmailId(val);
      },
    );
  }

  Widget _buildPasswordsField() {
    return FormBuilderTextField(
      attribute: "password",
      decoration: const InputDecoration(
        labelText: 'Password',
      ...
      onChanged: (val) => _loginStore.setPassword(val),
    );
  }
  ...
  Widget _buildSignInButton(BuildContext context) {
    return RoundedButtonWidget(
      buttonText: 'MASUK',
      buttonColor: _loginStore.canSignIn ? Colors.blue : Colors.grey,
