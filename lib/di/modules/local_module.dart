...
import 'package:app_jamaah_boilerplate/data/local/datasources/endpoint_datasource.dart';
import 'package:app_jamaah_boilerplate/data/local/datasources/user_datasource.dart';
...
import 'package:app_jamaah_boilerplate/utils/encryption/xxtea.dart';
...
class LocalModule extends NetworkModule {
  ...
  /// A singleton listing dataSource provider.
  ///
  /// Calling it multiple times will return the same instance.
  // @provide
  // @singleton
  // ListingDataSource provideListingDataSource() => ListingDataSource(database);

  // DataSources:---------------------------------------------------------------
  // Define all your data sources here
  /// A singleton admin dataSource provider.
  ///
  /// Calling it multiple times will return the same instance.
  @provide
  @singleton
  ...
  Repository provideRepository(
    ...
    UserDataSource userDataSource,
      ...
      Repository(baseApi, preferenceHelper, userDataSource);
}
